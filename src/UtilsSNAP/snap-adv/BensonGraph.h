...
class BensonGraph{
  ...
  public:
    ...
    void SaveAsLv(const TStr& file) const; //  to save the MAM in two binary files (structure and weights)
    WeightVHM& GetWeight();
...
template<class TypeGraph>
void BensonGraph<TypeGraph>::IncrementWeight(TIntV const& lnodes) {

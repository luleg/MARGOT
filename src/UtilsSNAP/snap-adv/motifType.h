...
public:
  ...
  bool IsInstance(const int& cpt_id,TIntV& orbs) const; // return true is cpt_id is a valid id of this quadrangle
};
...
public:
  ...
  bool IsInstance(const int& u, const int& v, const int& w, TIntV& orbs) const; // return true if the subgraph induced by nodes u,v,w is isomorphic to the motif

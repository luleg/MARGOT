...
public:
  BensonGraphTriangle(PNGraph& one_graph, MotifTypeTriangle& one_motif, TIntV const& orbs, bool decomp, bool verb =false);
  BensonGraphTriangle();
...
public:
  BensonGraphTriangleMP(PNGraph& one_graph, MotifTypeTriangle& one_motif, TIntV const& orbs, const TInt& nThreads, bool verb = false);
